    ...
    class account:
        ...
        class ban:
            ...
            def __call__(self, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("account.ban", owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
        ...
        class changePassword:
            ...
            def __call__(self, new_password, restore_sid : str = None, change_password_hash : str = None, old_password : str = None, v : str = None, access_token : str = None):
                return self.exec_func("account.changePassword", restore_sid = restore_sid, change_password_hash = change_password_hash, old_password = old_password, new_password = new_password, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getActiveOffers:
            ...
            def __call__(self, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("account.getActiveOffers", offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAppPermissions:
            ...
            def __call__(self, user_id, v : str = None, access_token : str = None):
                return self.exec_func("account.getAppPermissions", user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getBanned:
            ...
            def __call__(self, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("account.getBanned", offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCounters:
            ...
            def __call__(self, filter : str = None, v : str = None, access_token : str = None):
                return self.exec_func("account.getCounters", filter = filter, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getInfo:
            ...
            def __call__(self, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("account.getInfo", fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getProfileInfo:
            ...
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("account.getProfileInfo", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getPushSettings:
            ...
            def __call__(self, device_id : str = None, token : str = None, v : str = None, access_token : str = None):
                return self.exec_func("account.getPushSettings", device_id = device_id, token = token, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class registerDevice:
            ...
            def __call__(self, token, device_id, device_model : str = None, device_year : int = None, system_version : str = None, settings : str = None, sandbox : bool = None, no_text : int = None, subscribe : str = None, v : str = None, access_token : str = None):
                return self.exec_func("account.registerDevice", token = token, device_model = device_model, device_year = device_year, device_id = device_id, system_version = system_version, settings = settings, sandbox = sandbox, no_text = no_text, subscribe = subscribe, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setInfo:
            ...
            def __call__(self, name : str = None, value : str = None, intro : int = None, own_posts_default : bool = None, no_wall_replies : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("account.setInfo", name = name, value = value, intro = intro, own_posts_default = own_posts_default, no_wall_replies = no_wall_replies, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setNameInMenu:
            ...
            def __call__(self, user_id, name : str = None, v : str = None, access_token : str = None):
                return self.exec_func("account.setNameInMenu", user_id = user_id, name = name, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setOffline:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("account.setOffline", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setOnline:
            ...
            def __call__(self, voip : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("account.setOnline", voip = voip, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setPushSettings:
            ...
            def __call__(self, device_id, settings : str = None, key : str = None, value : str = None, v : str = None, access_token : str = None):
                return self.exec_func("account.setPushSettings", device_id = device_id, settings = settings, key = key, value = value, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setSilenceMode:
            ...
            def __call__(self, device_id : str = None, time : int = None, peer_id : int = None, sound : int = None, token : str = None, chat_id : int = None, user_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("account.setSilenceMode", device_id = device_id, time = time, peer_id = peer_id, sound = sound, token = token, chat_id = chat_id, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unban:
            ...
            def __call__(self, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("account.unban", owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unregisterDevice:
            ...
            def __call__(self, device_id : str = None, sandbox : bool = None, token : str = None, v : str = None, access_token : str = None):
                return self.exec_func("account.unregisterDevice", device_id = device_id, sandbox = sandbox, token = token, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class appWidgets:
        ...
        class getAppImageUploadServer:
            ...
            def __call__(self, image_type, v : str = None, access_token : str = None):
                return self.exec_func("appWidgets.getAppImageUploadServer", image_type = image_type, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAppImages:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("appWidgets.getAppImages", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getGroupImageUploadServer:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("appWidgets.getGroupImageUploadServer", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getGroupImages:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("appWidgets.getGroupImages", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getImagesById:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("appWidgets.getImagesById", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveAppImage:
            ...
            def __call__(self, hash, image, v : str = None, access_token : str = None):
                return self.exec_func("appWidgets.saveAppImage", hash = hash, image = image, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveGroupImage:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("appWidgets.saveGroupImage", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class update:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("appWidgets.update", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class apps:
        ...
        class deleteAppRequests:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("apps.deleteAppRequests", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, app_id : int = None, app_ids : str = None, platform : str = None, extended : bool = None, return_friends : bool = None, fields : str = None, name_case : str = None, v : str = None, access_token : str = None):
                return self.exec_func("apps.get", app_id = app_id, app_ids = app_ids, platform = platform, extended = extended, return_friends = return_friends, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCatalog:
            ...
            def __call__(self, count, sort : str = None, offset : int = None, platform : str = None, extended : bool = None, return_friends : bool = None, fields : str = None, name_case : str = None, q : str = None, genre_id : int = None, filter : str = None, v : str = None, access_token : str = None):
                return self.exec_func("apps.getCatalog", sort = sort, offset = offset, count = count, platform = platform, extended = extended, return_friends = return_friends, fields = fields, name_case = name_case, q = q, genre_id = genre_id, filter = filter, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getFriendsList:
            ...
            def __call__(self, extended : bool = None, count : int = None, offset : int = None, type : str = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("apps.getFriendsList", extended = extended, count = count, offset = offset, type = type, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLeaderboard:
            ...
            def __call__(self, type, global_ : bool = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("apps.getLeaderboard", type = type, global_ = global_, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getScopes:
            ...
            def __call__(self, type : str = None, v : str = None, access_token : str = None):
                return self.exec_func("apps.getScopes", type = type, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getScore:
            ...
            def __call__(self, user_id, v : str = None, access_token : str = None):
                return self.exec_func("apps.getScore", user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class promoHasActiveGift:
            ...
            def __call__(self, promo_id, user_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("apps.promoHasActiveGift", promo_id = promo_id, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class promoUseGift:
            ...
            def __call__(self, promo_id, user_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("apps.promoUseGift", promo_id = promo_id, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class sendRequest:
            ...
            def __call__(self, user_id, text : str = None, type : str = None, name : str = None, key : str = None, separate : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("apps.sendRequest", user_id = user_id, text = text, type = type, name = name, key = key, separate = separate, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class auth:
        ...
        class checkPhone:
            ...
            def __call__(self, phone, client_id : int = None, client_secret : str = None, auth_by_phone : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("auth.checkPhone", phone = phone, client_id = client_id, client_secret = client_secret, auth_by_phone = auth_by_phone, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
...
Данный метод доступен только приложениям, имеющим доступ к Прямой авторизации. '''
            ...
            def __call__(self, phone, last_name, v : str = None, access_token : str = None):
                return self.exec_func("auth.restore", phone = phone, last_name = last_name, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class board:
        ...
        class addTopic:
            ...
            def __call__(self, group_id, title, text : str = None, from_group : bool = None, attachments : str = None, v : str = None, access_token : str = None):
                return self.exec_func("board.addTopic", group_id = group_id, title = title, text = text, from_group = from_group, attachments = attachments, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class closeTopic:
            ...
            def __call__(self, group_id, topic_id, v : str = None, access_token : str = None):
                return self.exec_func("board.closeTopic", group_id = group_id, topic_id = topic_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class createComment:
            ...
            def __call__(self, group_id, topic_id, message : str = None, attachments : str = None, from_group : bool = None, sticker_id : int = None, guid : str = None, v : str = None, access_token : str = None):
                return self.exec_func("board.createComment", group_id = group_id, topic_id = topic_id, message = message, attachments = attachments, from_group = from_group, sticker_id = sticker_id, guid = guid, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteComment:
            ...
            def __call__(self, group_id, topic_id, comment_id, v : str = None, access_token : str = None):
                return self.exec_func("board.deleteComment", group_id = group_id, topic_id = topic_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteTopic:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества, в котором размещено обсуждение. положительное число, обязательный параметр", "type": "int", "default": "None"}, "topic_id": {"desc": "идентификатор обсуждения. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, topic_id, v : str = None, access_token : str = None):
                return self.exec_func("board.deleteTopic", group_id = group_id, topic_id = topic_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editComment:
            ...
            def __call__(self, group_id, topic_id, comment_id, message : str = None, attachments : str = None, v : str = None, access_token : str = None):
                return self.exec_func("board.editComment", group_id = group_id, topic_id = topic_id, comment_id = comment_id, message = message, attachments = attachments, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editTopic:
            ...
            def __call__(self, group_id, topic_id, title, v : str = None, access_token : str = None):
                return self.exec_func("board.editTopic", group_id = group_id, topic_id = topic_id, title = title, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class fixTopic:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества, в котором размещено обсуждение. положительное число, обязательный параметр", "type": "int", "default": "None"}, "topic_id": {"desc": "идентификатор обсуждения. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, topic_id, v : str = None, access_token : str = None):
                return self.exec_func("board.fixTopic", group_id = group_id, topic_id = topic_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getComments:
            ...
            def __call__(self, group_id, topic_id, need_likes : bool = None, start_comment_id : int = None, offset : int = None, count : int = None, extended : bool = None, sort : str = None, v : str = None, access_token : str = None):
                return self.exec_func("board.getComments", group_id = group_id, topic_id = topic_id, need_likes = need_likes, start_comment_id = start_comment_id, offset = offset, count = count, extended = extended, sort = sort, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getTopics:
            ...
            def __call__(self, group_id, topic_ids : str = None, order : int = None, offset : int = None, count : int = None, extended : bool = None, preview : int = None, preview_length : int = None, v : str = None, access_token : str = None):
                return self.exec_func("board.getTopics", group_id = group_id, topic_ids = topic_ids, order = order, offset = offset, count = count, extended = extended, preview = preview, preview_length = preview_length, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class openTopic:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества, в котором размещено обсуждение. положительное число, обязательный параметр", "type": "int", "default": "None"}, "topic_id": {"desc": "идентификатор обсуждения. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, topic_id, v : str = None, access_token : str = None):
                return self.exec_func("board.openTopic", group_id = group_id, topic_id = topic_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restoreComment:
            ...
            def __call__(self, group_id, topic_id, comment_id, v : str = None, access_token : str = None):
                return self.exec_func("board.restoreComment", group_id = group_id, topic_id = topic_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unfixTopic:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества, в котором размещено обсуждение. положительное число, обязательный параметр", "type": "int", "default": "None"}, "topic_id": {"desc": "идентификатор обсуждения. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, topic_id, v : str = None, access_token : str = None):
                return self.exec_func("board.unfixTopic", group_id = group_id, topic_id = topic_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class database:
        ...
        class getChairs:
            ...
            def __call__(self, faculty_id, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getChairs", faculty_id = faculty_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCities:
            ...
            def __call__(self, country_id, region_id : int = None, q : str = None, need_all : bool = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getCities", country_id = country_id, region_id = region_id, q = q, need_all = need_all, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCitiesById:
            ...
            def __call__(self, city_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getCitiesById", city_ids = city_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCountries:
            ...
            def __call__(self, need_all : bool = None, code : str = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getCountries", need_all = need_all, code = code, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCountriesById:
            ...
            def __call__(self, country_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getCountriesById", country_ids = country_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getFaculties:
            ...
            def __call__(self, university_id, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getFaculties", university_id = university_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMetroStations:
            ...
            def __call__(self, city_id, offset : int = None, count : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getMetroStations", city_id = city_id, offset = offset, count = count, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMetroStationsById:
            ...
            def __call__(self, station_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getMetroStationsById", station_ids = station_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getRegions:
            ...
            def __call__(self, country_id, q : str = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getRegions", country_id = country_id, q = q, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSchoolClasses:
            ...
            def __call__(self, country_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getSchoolClasses", country_id = country_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSchools:
            ...
            def __call__(self, city_id, q : str = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getSchools", q = q, city_id = city_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getUniversities:
            ...
            def __call__(self, q : str = None, country_id : int = None, city_id : int = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("database.getUniversities", q = q, country_id = country_id, city_id = city_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class docs:
        ...
        class add:
            ...
            def __call__(self, owner_id, doc_id, access_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.add", owner_id = owner_id, doc_id = doc_id, access_key = access_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, owner_id, doc_id, v : str = None, access_token : str = None):
                return self.exec_func("docs.delete", owner_id = owner_id, doc_id = doc_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, owner_id, doc_id, title : str = None, tags : str = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.edit", owner_id = owner_id, doc_id = doc_id, title = title, tags = tags, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
...
'''
            ...
            def __call__(self, count : int = None, offset : int = None, type : int = None, owner_id : int = None, return_tags : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.get", count = count, offset = offset, type = type, owner_id = owner_id, return_tags = return_tags, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, docs, return_tags : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.getById", docs = docs, return_tags = return_tags, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMessagesUploadServer:
            ...
            def __call__(self, type : str = None, peer_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.getMessagesUploadServer", type = type, peer_id = peer_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getTypes:
            ...
            def __call__(self, owner_id, v : str = None, access_token : str = None):
                return self.exec_func("docs.getTypes", owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
...
'''
            ...
            def __call__(self, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.getUploadServer", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getWallUploadServer:
            ...
            def __call__(self, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.getWallUploadServer", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class save:
            ...
            def __call__(self, file, title : str = None, tags : str = None, return_tags : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.save", file = file, title = title, tags = tags, return_tags = return_tags, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, q, search_own : bool = None, count : int = None, offset : int = None, return_tags : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("docs.search", q = q, search_own = search_own, count = count, offset = offset, return_tags = return_tags, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class donut:
        ...
        class getFriends:
            ...
            def __call__(self, owner_id, offset : int = None, count : int = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("donut.getFriends", owner_id = owner_id, offset = offset, count = count, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSubscription:
            ...
            def __call__(self, owner_id, v : str = None, access_token : str = None):
                return self.exec_func("donut.getSubscription", owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSubscriptions:
            ...
            def __call__(self, fields : str = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("donut.getSubscriptions", fields = fields, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class isDon:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"owner_id": {"desc": "идентификатор сообщества. \nОбратите внимание, идентификатор сообщества в параметре owner_id необходимо указывать со знаком \"-\" — например, owner_id=-1 соответствует идентификатору сообщества ВКонтакте API (club1)  целое число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, owner_id, v : str = None, access_token : str = None):
                return self.exec_func("donut.isDon", owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class downloadedGames:
        ...
        class getPaidStatus:
            ...
            def __call__(self, user_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("downloadedGames.getPaidStatus", user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class fave:
        ...
        class addArticle:
            ...
            def __call__(self, url, v : str = None, access_token : str = None):
                return self.exec_func("fave.addArticle", url = url, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addLink:
            ...
            def __call__(self, link, v : str = None, access_token : str = None):
                return self.exec_func("fave.addLink", link = link, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addPage:
            ...
            def __call__(self, user_id : int = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.addPage", user_id = user_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addPost:
            ...
            def __call__(self, owner_id, id, access_key : str = None, ref : str = None, track_code : str = None, source : str = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.addPost", owner_id = owner_id, id = id, access_key = access_key, ref = ref, track_code = track_code, source = source, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addProduct:
            ...
            def __call__(self, owner_id, id, access_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.addProduct", owner_id = owner_id, id = id, access_key = access_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addTag:
            ...
            def __call__(self, name : str = None, position : str = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.addTag", name = name, position = position, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addVideo:
            ...
            def __call__(self, owner_id, id, access_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.addVideo", owner_id = owner_id, id = id, access_key = access_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editTag:
            ...
            def __call__(self, id, name, v : str = None, access_token : str = None):
                return self.exec_func("fave.editTag", id = id, name = name, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, extended : bool = None, item_type : str = None, tag_id : int = None, offset : int = None, count : int = None, fields : str = None, is_from_snackbar : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.get", extended = extended, item_type = item_type, tag_id = tag_id, offset = offset, count = count, fields = fields, is_from_snackbar = is_from_snackbar, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getPages:
            ...
            def __call__(self, offset : int = None, count : int = None, type : str = None, fields : str = None, tag_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.getPages", offset = offset, count = count, type = type, fields = fields, tag_id = tag_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getTags:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("fave.getTags", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class markSeen:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("fave.markSeen", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeArticle:
            ...
            def __call__(self, owner_id, article_id, ref : str = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.removeArticle", owner_id = owner_id, article_id = article_id, ref = ref, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeLink:
            ...
            def __call__(self, link_id : str = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.removeLink", link_id = link_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removePage:
            ...
            def __call__(self, user_id : int = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.removePage", user_id = user_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removePost:
            ...
            def __call__(self, owner_id, id, v : str = None, access_token : str = None):
                return self.exec_func("fave.removePost", owner_id = owner_id, id = id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeProduct:
            ...
            def __call__(self, owner_id, id, v : str = None, access_token : str = None):
                return self.exec_func("fave.removeProduct", owner_id = owner_id, id = id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeTag:
            ...
            def __call__(self, id, v : str = None, access_token : str = None):
                return self.exec_func("fave.removeTag", id = id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeVideo:
            ...
            def __call__(self, owner_id, id, v : str = None, access_token : str = None):
                return self.exec_func("fave.removeVideo", owner_id = owner_id, id = id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reorderTags:
            ...
            def __call__(self, ids, v : str = None, access_token : str = None):
                return self.exec_func("fave.reorderTags", ids = ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setPageTags:
            ...
            def __call__(self, user_id : int = None, group_id : int = None, tag_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.setPageTags", user_id = user_id, group_id = group_id, tag_ids = tag_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setTags:
            ...
            def __call__(self, item_type : str = None, item_owner_id : int = None, item_id : int = None, tag_ids : str = None, link_id : str = None, link_url : str = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.setTags", item_type = item_type, item_owner_id = item_owner_id, item_id = item_id, tag_ids = tag_ids, link_id = link_id, link_url = link_url, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class trackPageInteraction:
            ...
            def __call__(self, user_id : int = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("fave.trackPageInteraction", user_id = user_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class friends:
        ...
        class add:
            ...
            def __call__(self, user_id : int = None, text : str = None, follow : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.add", user_id = user_id, text = text, follow = follow, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addList:
            ...
            def __call__(self, name, user_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.addList", name = name, user_ids = user_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class areFriends:
            ...
            def __call__(self, user_ids, need_sign : bool = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.areFriends", user_ids = user_ids, need_sign = need_sign, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, user_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.delete", user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteAllRequests:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("friends.deleteAllRequests", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteList:
            ...
            def __call__(self, list_id, v : str = None, access_token : str = None):
                return self.exec_func("friends.deleteList", list_id = list_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, user_id, list_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.edit", user_id = user_id, list_ids = list_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editList:
            ...
            def __call__(self, list_id, name : str = None, user_ids : str = None, add_user_ids : str = None, delete_user_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.editList", name = name, list_id = list_id, user_ids = user_ids, add_user_ids = add_user_ids, delete_user_ids = delete_user_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, user_id : int = None, order : str = None, list_id : int = None, count : int = None, offset : int = None, fields : str = None, name_case : str = None, ref : str = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.get", user_id = user_id, order = order, list_id = list_id, count = count, offset = offset, fields = fields, name_case = name_case, ref = ref, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAppUsers:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("friends.getAppUsers", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getByPhones:
            ...
            def __call__(self, phones : str = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.getByPhones", phones = phones, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLists:
            ...
            def __call__(self, user_id : int = None, return_system : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.getLists", user_id = user_id, return_system = return_system, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMutual:
            ...
            def __call__(self, source_uid : int = None, target_uid : int = None, target_uids : str = None, order : str = None, count : int = None, offset : int = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.getMutual", source_uid = source_uid, target_uid = target_uid, target_uids = target_uids, order = order, count = count, offset = offset, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getOnline:
            ...
            def __call__(self, user_id : int = None, list_id : int = None, online_mobile : bool = None, order : str = None, count : int = None, offset : int = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.getOnline", user_id = user_id, list_id = list_id, online_mobile = online_mobile, order = order, count = count, offset = offset, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getRecent:
            ...
            def __call__(self, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.getRecent", count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
...
'''
            ...
            def __call__(self, offset : int = None, count : int = None, extended : bool = None, need_mutual : bool = None, out : bool = None, sort : int = None, need_viewed : bool = None, suggested : bool = None, ref : str = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.getRequests", offset = offset, count = count, extended = extended, need_mutual = need_mutual, out = out, sort = sort, need_viewed = need_viewed, suggested = suggested, ref = ref, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSuggestions:
            ...
            def __call__(self, filter : str = None, count : int = None, offset : int = None, fields : str = None, name_case : str = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.getSuggestions", filter = filter, count = count, offset = offset, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, user_id, q : str = None, fields : str = None, name_case : str = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("friends.search", user_id = user_id, q = q, fields = fields, name_case = name_case, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class gifts:
        ...
        class get:
            ...
            def __call__(self, user_id : int = None, count : int = None, offset : int = None, v : str = None, access_token : str = None):
                return self.exec_func("gifts.get", user_id = user_id, count = count, offset = offset, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
...
Для того, чтобы воспользоваться этим методом, Вы должны быть администратором сообщества '''
        ...
        class addCallbackServer:
            ...
            def __call__(self, group_id, url, title, secret_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.addCallbackServer", group_id = group_id, url = url, title = title, secret_key = secret_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addLink:
            ...
            def __call__(self, group_id, link, text : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.addLink", group_id = group_id, link = link, text = text, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class approveRequest:
            ...
            def __call__(self, group_id, user_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.approveRequest", group_id = group_id, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class ban:
            ...
            def __call__(self, group_id, owner_id : int = None, end_date : int = None, reason : int = None, comment : str = None, comment_visible : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.ban", group_id = group_id, owner_id = owner_id, end_date = end_date, reason = reason, comment = comment, comment_visible = comment_visible, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class create:
            ...
            def __call__(self, title, description : str = None, type : str = None, public_category : int = None, subtype : int = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.create", title = title, description = description, type = type, public_category = public_category, subtype = subtype, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteAddress:
            ...
            def __call__(self, group_id, address_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.deleteAddress", group_id = group_id, address_id = address_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteCallbackServer:
            ...
            def __call__(self, group_id, server_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.deleteCallbackServer", group_id = group_id, server_id = server_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteLink:
            ...
            def __call__(self, group_id, link_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.deleteLink", group_id = group_id, link_id = link_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class disableOnline:
            ...
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.disableOnline", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
...
Для того, чтобы воспользоваться этим методом, Вы должны быть администратором сообщества '''
        ...
        class editCallbackServer:
            ...
            def __call__(self, group_id, server_id, url, title, secret_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.editCallbackServer", group_id = group_id, server_id = server_id, url = url, title = title, secret_key = secret_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editLink:
            ...
            def __call__(self, group_id, link_id, text : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.editLink", group_id = group_id, link_id = link_id, text = text, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editManager:
            ...
            def __call__(self, group_id, user_id, role : str = None, is_contact : bool = None, contact_position : str = None, contact_phone : str = None, contact_email : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.editManager", group_id = group_id, user_id = user_id, role = role, is_contact = is_contact, contact_position = contact_position, contact_phone = contact_phone, contact_email = contact_email, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class enableOnline:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.enableOnline", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, user_id : int = None, extended : bool = None, filter : str = None, fields : str = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.get", user_id = user_id, extended = extended, filter = filter, fields = fields, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAddresses:
            ...
            def __call__(self, group_id, address_ids : str = None, latitude : int = None, longitude : int = None, offset : int = None, count : int = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getAddresses", group_id = group_id, address_ids = address_ids, latitude = latitude, longitude = longitude, offset = offset, count = count, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getBanned:
            ...
            def __call__(self, group_id, offset : int = None, count : int = None, fields : str = None, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getBanned", group_id = group_id, offset = offset, count = count, fields = fields, owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, group_ids : str = None, group_id : str = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getById", group_ids = group_ids, group_id = group_id, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCallbackConfirmationCode:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.getCallbackConfirmationCode", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCallbackServers:
            ...
            def __call__(self, group_id, server_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getCallbackServers", group_id = group_id, server_ids = server_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCallbackSettings:
            ...
            def __call__(self, group_id, server_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getCallbackSettings", group_id = group_id, server_id = server_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCatalog:
            ...
            def __call__(self, category_id : int = None, subcategory_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getCatalog", category_id = category_id, subcategory_id = subcategory_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCatalogInfo:
            ...
            def __call__(self, extended : bool = None, subcategories : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getCatalogInfo", extended = extended, subcategories = subcategories, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getInvitedUsers:
            ...
            def __call__(self, group_id, offset : int = None, count : int = None, fields : str = None, name_case : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getInvitedUsers", group_id = group_id, offset = offset, count = count, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getInvites:
            ...
            def __call__(self, offset : int = None, count : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getInvites", offset = offset, count = count, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLongPollServer:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.getLongPollServer", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLongPollSettings:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.getLongPollSettings", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMembers:
            ...
            def __call__(self, group_id : str = None, sort : str = None, offset : int = None, count : int = None, fields : str = None, filter : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getMembers", group_id = group_id, sort = sort, offset = offset, count = count, fields = fields, filter = filter, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getOnlineStatus:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.getOnlineStatus", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getRequests:
            ...
            def __call__(self, group_id, offset : int = None, count : int = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.getRequests", group_id = group_id, offset = offset, count = count, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSettings:
            ...
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.getSettings", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getTagList:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "Идентификатор сообщества положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.getTagList", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getTokenPermissions:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("groups.getTokenPermissions", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class invite:
            ...
            def __call__(self, group_id, user_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.invite", group_id = group_id, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class isMember:
            ...
            def __call__(self, group_id, user_id : int = None, user_ids : str = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.isMember", group_id = group_id, user_id = user_id, user_ids = user_ids, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class join:
            ...
            def __call__(self, group_id : int = None, not_sure : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.join", group_id = group_id, not_sure = not_sure, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class leave:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.leave", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeUser:
            ...
            def __call__(self, group_id, user_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.removeUser", group_id = group_id, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reorderLink:
            ...
            def __call__(self, group_id, link_id, after : int = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.reorderLink", group_id = group_id, link_id = link_id, after = after, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, q, type : str = None, country_id : int = None, city_id : int = None, future : bool = None, market : bool = None, sort : int = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.search", q = q, type = type, country_id = country_id, city_id = city_id, future = future, market = market, sort = sort, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setSettings:
            ...
            def __call__(self, group_id, messages : bool = None, bots_capabilities : bool = None, bots_start_button : bool = None, bots_add_to_chat : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.setSettings", group_id = group_id, messages = messages, bots_capabilities = bots_capabilities, bots_start_button = bots_start_button, bots_add_to_chat = bots_add_to_chat, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setUserNote:
            ...
            def __call__(self, group_id, user_id, note : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.setUserNote", group_id = group_id, user_id = user_id, note = note, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class tagAdd:
            ...
            def __call__(self, group_id, tag_name, tag_color : str = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.tagAdd", group_id = group_id, tag_name = tag_name, tag_color = tag_color, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class tagBind:
            ...
            def __call__(self, group_id, tag_id, user_id, act, v : str = None, access_token : str = None):
                return self.exec_func("groups.tagBind", group_id = group_id, tag_id = tag_id, user_id = user_id, act = act, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class tagDelete:
            ...
            def __call__(self, group_id, tag_id, v : str = None, access_token : str = None):
                return self.exec_func("groups.tagDelete", group_id = group_id, tag_id = tag_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class tagUpdate:
            ...
            def __call__(self, group_id, tag_id, tag_name, v : str = None, access_token : str = None):
                return self.exec_func("groups.tagUpdate", group_id = group_id, tag_id = tag_id, tag_name = tag_name, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class toggleMarket:
            ...
            def __call__(self, group_id, state, v : str = None, access_token : str = None):
                return self.exec_func("groups.toggleMarket", group_id = group_id, state = state, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unban:
            ...
            def __call__(self, group_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("groups.unban", group_id = group_id, owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class leadForms:
        ...
        class create:
            ...
            def __call__(self, group_id, name, title, description, questions, policy_link_url, photo : str = None, confirmation : str = None, site_link_url : str = None, active : bool = None, once_per_user : bool = None, pixel_code : str = None, notify_admins : str = None, notify_emails : str = None, v : str = None, access_token : str = None):
                return self.exec_func("leadForms.create", group_id = group_id, name = name, title = title, description = description, questions = questions, policy_link_url = policy_link_url, photo = photo, confirmation = confirmation, site_link_url = site_link_url, active = active, once_per_user = once_per_user, pixel_code = pixel_code, notify_admins = notify_admins, notify_emails = notify_emails, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, group_id, form_id, v : str = None, access_token : str = None):
                return self.exec_func("leadForms.delete", group_id = group_id, form_id = form_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, group_id, form_id, v : str = None, access_token : str = None):
                return self.exec_func("leadForms.get", group_id = group_id, form_id = form_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLeads:
            ...
            def __call__(self, group_id, form_id, limit : int = None, next_page_token : str = None, v : str = None, access_token : str = None):
                return self.exec_func("leadForms.getLeads", group_id = group_id, form_id = form_id, limit = limit, next_page_token = next_page_token, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getUploadURL:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("leadForms.getUploadURL", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class list:
            ...
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("leadForms.list", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class update:
            ...
            def __call__(self, group_id, form_id, name, title, description, questions, policy_link_url, photo : str = None, confirmation : str = None, site_link_url : str = None, active : bool = None, once_per_user : bool = None, pixel_code : str = None, notify_admins : str = None, notify_emails : str = None, v : str = None, access_token : str = None):
                return self.exec_func("leadForms.update", group_id = group_id, form_id = form_id, name = name, title = title, description = description, questions = questions, policy_link_url = policy_link_url, photo = photo, confirmation = confirmation, site_link_url = site_link_url, active = active, once_per_user = once_per_user, pixel_code = pixel_code, notify_admins = notify_admins, notify_emails = notify_emails, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class likes:
        ...
        class add:
            ...
            def __call__(self, type, item_id, owner_id : int = None, access_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("likes.add", type = type, owner_id = owner_id, item_id = item_id, access_key = access_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, type, item_id, owner_id : int = None, access_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("likes.delete", type = type, owner_id = owner_id, item_id = item_id, access_key = access_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getList:
            ...
            def __call__(self, type, owner_id : int = None, item_id : int = None, page_url : str = None, filter : str = None, friends_only : int = None, extended : bool = None, offset : int = None, count : int = None, skip_own : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("likes.getList", type = type, owner_id = owner_id, item_id = item_id, page_url = page_url, filter = filter, friends_only = friends_only, extended = extended, offset = offset, count = count, skip_own = skip_own, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class isLiked:
            ...
            def __call__(self, type, item_id, user_id : int = None, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("likes.isLiked", user_id = user_id, type = type, owner_id = owner_id, item_id = item_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class market:
        ...
        class addAlbum:
            ...
            def __call__(self, owner_id, title, photo_id : int = None, main_album : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("market.addAlbum", owner_id = owner_id, title = title, photo_id = photo_id, main_album = main_album, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addToAlbum:
            ...
            def __call__(self, owner_id, item_id, album_ids, v : str = None, access_token : str = None):
                return self.exec_func("market.addToAlbum", owner_id = owner_id, item_id = item_id, album_ids = album_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class createComment:
            ...
            def __call__(self, owner_id, item_id, message : str = None, attachments : str = None, from_group : bool = None, reply_to_comment : int = None, sticker_id : int = None, guid : str = None, v : str = None, access_token : str = None):
                return self.exec_func("market.createComment", owner_id = owner_id, item_id = item_id, message = message, attachments = attachments, from_group = from_group, reply_to_comment = reply_to_comment, sticker_id = sticker_id, guid = guid, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, owner_id, item_id, v : str = None, access_token : str = None):
                return self.exec_func("market.delete", owner_id = owner_id, item_id = item_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteAlbum:
            ...
            def __call__(self, owner_id, album_id, v : str = None, access_token : str = None):
                return self.exec_func("market.deleteAlbum", owner_id = owner_id, album_id = album_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteComment:
            ...
            def __call__(self, owner_id, comment_id, v : str = None, access_token : str = None):
                return self.exec_func("market.deleteComment", owner_id = owner_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, owner_id, item_id, name : str = None, description : str = None, category_id : int = None, price : int = None, old_price : int = None, deleted : bool = None, main_photo_id : int = None, photo_ids : str = None, url : str = None, dimension_width : int = None, dimension_height : int = None, dimension_length : int = None, weight : int = None, sku : str = None, v : str = None, access_token : str = None):
                return self.exec_func("market.edit", owner_id = owner_id, item_id = item_id, name = name, description = description, category_id = category_id, price = price, old_price = old_price, deleted = deleted, main_photo_id = main_photo_id, photo_ids = photo_ids, url = url, dimension_width = dimension_width, dimension_height = dimension_height, dimension_length = dimension_length, weight = weight, sku = sku, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editAlbum:
            ...
            def __call__(self, owner_id, album_id, title, photo_id : int = None, main_album : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("market.editAlbum", owner_id = owner_id, album_id = album_id, title = title, photo_id = photo_id, main_album = main_album, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editComment:
            ...
            def __call__(self, owner_id, comment_id, message : str = None, attachments : str = None, v : str = None, access_token : str = None):
                return self.exec_func("market.editComment", owner_id = owner_id, comment_id = comment_id, message = message, attachments = attachments, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editOrder:
            ...
            def __call__(self, user_id, order_id, merchant_comment : str = None, status : int = None, track_number : str = None, payment_status : str = None, delivery_price : int = None, width : int = None, length : int = None, height : int = None, weight : int = None, v : str = None, access_token : str = None):
                return self.exec_func("market.editOrder", user_id = user_id, order_id = order_id, merchant_comment = merchant_comment, status = status, track_number = track_number, payment_status = payment_status, delivery_price = delivery_price, width = width, length = length, height = height, weight = weight, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, owner_id, album_id = None, count : int = None, offset : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("market.get", owner_id = owner_id, album_id = album_id, count = count, offset = offset, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAlbumById:
            ...
            def __call__(self, owner_id, album_ids, v : str = None, access_token : str = None):
                return self.exec_func("market.getAlbumById", owner_id = owner_id, album_ids = album_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAlbums:
            ...
            def __call__(self, owner_id, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("market.getAlbums", owner_id = owner_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, item_ids, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("market.getById", item_ids = item_ids, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getCategories:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("market.getCategories", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getComments:
            ...
            def __call__(self, owner_id, item_id, need_likes : bool = None, start_comment_id : int = None, offset : int = None, count : int = None, sort : str = None, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("market.getComments", owner_id = owner_id, item_id = item_id, need_likes = need_likes, start_comment_id = start_comment_id, offset = offset, count = count, sort = sort, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getGroupOrders:
            ...
            def __call__(self, group_id, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("market.getGroupOrders", group_id = group_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getOrderById:
            ...
            def __call__(self, order_id, user_id : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("market.getOrderById", user_id = user_id, order_id = order_id, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getOrderItems:
            ...
            def __call__(self, order_id, user_id : int = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("market.getOrderItems", user_id = user_id, order_id = order_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getOrders:
            ...
            def __call__(self, offset : int = None, count : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("market.getOrders", offset = offset, count = count, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeFromAlbum:
            ...
            def __call__(self, owner_id, item_id, album_ids, v : str = None, access_token : str = None):
                return self.exec_func("market.removeFromAlbum", owner_id = owner_id, item_id = item_id, album_ids = album_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reorderAlbums:
            ...
            def __call__(self, owner_id, album_id, before : int = None, after : int = None, v : str = None, access_token : str = None):
                return self.exec_func("market.reorderAlbums", owner_id = owner_id, album_id = album_id, before = before, after = after, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reorderItems:
            ...
            def __call__(self, owner_id, item_id, album_id : int = None, before : int = None, after : int = None, v : str = None, access_token : str = None):
                return self.exec_func("market.reorderItems", owner_id = owner_id, album_id = album_id, item_id = item_id, before = before, after = after, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class report:
            ...
            def __call__(self, owner_id, item_id, reason, v : str = None, access_token : str = None):
                return self.exec_func("market.report", owner_id = owner_id, item_id = item_id, reason = reason, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reportComment:
            ...
            def __call__(self, owner_id, comment_id, reason, v : str = None, access_token : str = None):
                return self.exec_func("market.reportComment", owner_id = owner_id, comment_id = comment_id, reason = reason, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restore:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"owner_id": {"desc": "идентификатор владельца товара. \nОбратите внимание, идентификатор сообщества в параметре owner_id необходимо указывать со знаком \"-\" — например, owner_id=-1 соответствует идентификатору сообщества ВКонтакте API (club1)  целое число, обязательный параметр", "type": "int", "default": "None"}, "item_id": {"desc": "идентификатор товара. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, owner_id, item_id, v : str = None, access_token : str = None):
                return self.exec_func("market.restore", owner_id = owner_id, item_id = item_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restoreComment:
            ...
            def __call__(self, owner_id, comment_id, v : str = None, access_token : str = None):
                return self.exec_func("market.restoreComment", owner_id = owner_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, owner_id, album_id : int = None, q : str = None, price_from : int = None, price_to : int = None, sort : int = None, rev : int = None, offset : int = None, count : int = None, extended : bool = None, status : int = None, v : str = None, access_token : str = None):
                return self.exec_func("market.search", owner_id = owner_id, album_id = album_id, q = q, price_from = price_from, price_to = price_to, sort = sort, rev = rev, offset = offset, count = count, extended = extended, status = status, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class messages:
        ...
        class addChatUser:
            ...
            def __call__(self, chat_id, user_id : int = None, visible_messages_count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.addChatUser", chat_id = chat_id, user_id = user_id, visible_messages_count = visible_messages_count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class allowMessagesFromGroup:
            ...
            def __call__(self, group_id, key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.allowMessagesFromGroup", group_id = group_id, key = key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class createChat:
            ...
            def __call__(self, user_ids : str = None, title : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.createChat", user_ids = user_ids, title = title, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, message_ids : str = None, spam : bool = None, group_id : int = None, delete_for_all : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.delete", message_ids = message_ids, spam = spam, group_id = group_id, delete_for_all = delete_for_all, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteChatPhoto:
            ...
            def __call__(self, chat_id, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.deleteChatPhoto", chat_id = chat_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteConversation:
            ...
            def __call__(self, user_id : str = None, peer_id : int = None, group_id : int = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.deleteConversation", user_id = user_id, peer_id = peer_id, group_id = group_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class denyMessagesFromGroup:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"group_id": {"desc": "идентификатор сообщества. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("messages.denyMessagesFromGroup", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, peer_id, message : str = None, lat : int = None, long : int = None, attachment : str = None, keep_forward_messages : bool = None, keep_snippets : bool = None, group_id : int = None, dont_parse_links : bool = None, message_id : int = None, conversation_message_id : int = None, template = None, keyboard = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.edit", peer_id = peer_id, message = message, lat = lat, long = long, attachment = attachment, keep_forward_messages = keep_forward_messages, keep_snippets = keep_snippets, group_id = group_id, dont_parse_links = dont_parse_links, message_id = message_id, conversation_message_id = conversation_message_id, template = template, keyboard = keyboard, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editChat:
            ...
            def __call__(self, chat_id, title, v : str = None, access_token : str = None):
                return self.exec_func("messages.editChat", chat_id = chat_id, title = title, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getByConversationMessageId:
            ...
            def __call__(self, peer_id, conversation_message_ids, extended : bool = None, fields : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getByConversationMessageId", peer_id = peer_id, conversation_message_ids = conversation_message_ids, extended = extended, fields = fields, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, message_ids, preview_length : int = None, extended : bool = None, fields : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getById", message_ids = message_ids, preview_length = preview_length, extended = extended, fields = fields, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getChat:
            ...
            def __call__(self, chat_id : int = None, chat_ids : str = None, fields : str = None, name_case : str = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getChat", chat_id = chat_id, chat_ids = chat_ids, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getChatPreview:
            ...
            def __call__(self, peer_id : int = None, link : str = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getChatPreview", peer_id = peer_id, link = link, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getConversationMembers:
            ...
            def __call__(self, peer_id, fields : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getConversationMembers", peer_id = peer_id, fields = fields, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getConversations:
            ...
            def __call__(self, offset : int = None, count : int = None, filter : str = None, extended : bool = None, start_message_id : int = None, fields : str = None, group_id = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getConversations", offset = offset, count = count, filter = filter, extended = extended, start_message_id = start_message_id, fields = fields, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getConversationsById:
            ...
            def __call__(self, peer_ids, extended : bool = None, fields : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getConversationsById", peer_ids = peer_ids, extended = extended, fields = fields, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getHistory:
            ...
            def __call__(self, offset : int = None, count : int = None, user_id : str = None, peer_id : int = None, start_message_id : int = None, rev : int = None, extended : bool = None, fields : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getHistory", offset = offset, count = count, user_id = user_id, peer_id = peer_id, start_message_id = start_message_id, rev = rev, extended = extended, fields = fields, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getHistoryAttachments:
            ...
            def __call__(self, peer_id, media_type : str = None, start_from : str = None, count : int = None, photo_sizes : bool = None, fields : str = None, group_id : int = None, preserve_order : bool = None, max_forwards_level : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getHistoryAttachments", peer_id = peer_id, media_type = media_type, start_from = start_from, count = count, photo_sizes = photo_sizes, fields = fields, group_id = group_id, preserve_order = preserve_order, max_forwards_level = max_forwards_level, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getImportantMessages:
            ...
            def __call__(self, count : int = None, offset : int = None, start_message_id : int = None, preview_length : int = None, fields : str = None, extended : bool = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getImportantMessages", count = count, offset = offset, start_message_id = start_message_id, preview_length = preview_length, fields = fields, extended = extended, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getInviteLink:
            ...
            def __call__(self, peer_id, reset : bool = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getInviteLink", peer_id = peer_id, reset = reset, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLastActivity:
            ...
            def __call__(self, user_id, v : str = None, access_token : str = None):
                return self.exec_func("messages.getLastActivity", user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
...
'''
            ...
            def __call__(self, ts : int = None, pts : int = None, preview_length : int = None, onlines : bool = None, fields : str = None, events_limit : int = None, msgs_limit : int = None, max_msg_id : int = None, group_id : int = None, lp_version : int = None, last_n : int = None, credentials : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getLongPollHistory", ts = ts, pts = pts, preview_length = preview_length, onlines = onlines, fields = fields, events_limit = events_limit, msgs_limit = msgs_limit, max_msg_id = max_msg_id, group_id = group_id, lp_version = lp_version, last_n = last_n, credentials = credentials, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLongPollServer:
            ...
            def __call__(self, need_pts : bool = None, group_id : int = None, lp_version : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.getLongPollServer", need_pts = need_pts, group_id = group_id, lp_version = lp_version, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class isMessagesFromGroupAllowed:
            ...
            def __call__(self, group_id, user_id, v : str = None, access_token : str = None):
                return self.exec_func("messages.isMessagesFromGroupAllowed", group_id = group_id, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class joinChatByInviteLink:
            ...
            def __call__(self, link, v : str = None, access_token : str = None):
                return self.exec_func("messages.joinChatByInviteLink", link = link, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class markAsAnsweredConversation:
            ...
            def __call__(self, peer_id, answered : bool = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.markAsAnsweredConversation", peer_id = peer_id, answered = answered, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class markAsImportant:
            ...
            def __call__(self, message_ids : str = None, important : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.markAsImportant", message_ids = message_ids, important = important, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class markAsImportantConversation:
            ...
            def __call__(self, peer_id, important : bool = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.markAsImportantConversation", peer_id = peer_id, important = important, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class markAsRead:
            ...
            def __call__(self, message_ids : str = None, peer_id : str = None, start_message_id : int = None, group_id : int = None, mark_conversation_as_read : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.markAsRead", message_ids = message_ids, peer_id = peer_id, start_message_id = start_message_id, group_id = group_id, mark_conversation_as_read = mark_conversation_as_read, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class pin:
            ...
            def __call__(self, peer_id, message_id : int = None, conversation_message_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.pin", peer_id = peer_id, message_id = message_id, conversation_message_id = conversation_message_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeChatUser:
            ...
            def __call__(self, chat_id, user_id = None, member_id = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.removeChatUser", chat_id = chat_id, user_id = user_id, member_id = member_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restore:
            ...
            def __call__(self, message_id, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.restore", message_id = message_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, q : str = None, peer_id : int = None, date : int = None, preview_length : int = None, offset : int = None, count : int = None, extended : bool = None, fields : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.search", q = q, peer_id = peer_id, date = date, preview_length = preview_length, offset = offset, count = count, extended = extended, fields = fields, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class searchConversations:
            ...
            def __call__(self, q : str = None, count : int = None, extended : bool = None, fields : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.searchConversations", q = q, count = count, extended = extended, fields = fields, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class sendMessageEventAnswer:
            ...
            def __call__(self, event_id, user_id, peer_id, event_data = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.sendMessageEventAnswer", event_id = event_id, user_id = user_id, peer_id = peer_id, event_data = event_data, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setActivity:
            ...
            def __call__(self, user_id : str = None, type : str = None, peer_id : int = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.setActivity", user_id = user_id, type = type, peer_id = peer_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setChatPhoto:
            ...
            def __call__(self, file, v : str = None, access_token : str = None):
                return self.exec_func("messages.setChatPhoto", file = file, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unpin:
            ...
            def __call__(self, peer_id, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("messages.unpin", peer_id = peer_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class newsfeed:
        ...
        class addBan:
            ...
            def __call__(self, user_ids : str = None, group_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.addBan", user_ids = user_ids, group_ids = group_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteBan:
            ...
            def __call__(self, user_ids : str = None, group_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.deleteBan", user_ids = user_ids, group_ids = group_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteList:
            ...
            def __call__(self, list_id, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.deleteList", list_id = list_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, filters : str = None, return_banned : bool = None, start_time : int = None, end_time : int = None, max_photos : int = None, source_ids : str = None, start_from : str = None, count : int = None, fields : str = None, section : str = None, from_ : str = None, offset : int = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.get", filters = filters, return_banned = return_banned, start_time = start_time, end_time = end_time, max_photos = max_photos, source_ids = source_ids, start_from = start_from, count = count, fields = fields, section = section, from_ = from_, offset = offset, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getBanned:
            ...
            def __call__(self, extended : bool = None, fields : str = None, name_case : str = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.getBanned", extended = extended, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getComments:
            ...
            def __call__(self, count : int = None, filters : str = None, reposts : str = None, start_time : int = None, end_time : int = None, last_comments_count : int = None, start_from : str = None, fields : str = None, from_ : str = None, last_comments : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.getComments", count = count, filters = filters, reposts = reposts, start_time = start_time, end_time = end_time, last_comments_count = last_comments_count, start_from = start_from, fields = fields, from_ = from_, last_comments = last_comments, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLists:
            ...
            def __call__(self, list_ids : str = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.getLists", list_ids = list_ids, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMentions:
            ...
            def __call__(self, owner_id : int = None, start_time : int = None, end_time : int = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.getMentions", owner_id = owner_id, start_time = start_time, end_time = end_time, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getRecommended:
            ...
            def __call__(self, start_time : int = None, end_time : int = None, max_photos : int = None, start_from : str = None, count : int = None, fields : str = None, from_ : str = None, offset : int = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.getRecommended", start_time = start_time, end_time = end_time, max_photos = max_photos, start_from = start_from, count = count, fields = fields, from_ = from_, offset = offset, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSuggestedSources:
            ...
            def __call__(self, offset : int = None, count : int = None, shuffle : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.getSuggestedSources", offset = offset, count = count, shuffle = shuffle, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class ignoreItem:
            ...
            def __call__(self, type, owner_id : int = None, item_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.ignoreItem", type = type, owner_id = owner_id, item_id = item_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveList:
            ...
            def __call__(self, title, list_id : int = None, source_ids : str = None, no_reposts : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.saveList", list_id = list_id, title = title, source_ids = source_ids, no_reposts = no_reposts, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, q : str = None, extended : bool = None, count : int = None, latitude : int = None, longitude : int = None, start_time : int = None, end_time : int = None, start_from : str = None, fields : str = None, start_id : str = None, offset : int = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.search", q = q, extended = extended, count = count, latitude = latitude, longitude = longitude, start_time = start_time, end_time = end_time, start_from = start_from, fields = fields, start_id = start_id, offset = offset, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unignoreItem:
            ...
            def __call__(self, type, owner_id, item_id, track_code : str = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.unignoreItem", type = type, owner_id = owner_id, item_id = item_id, track_code = track_code, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unsubscribe:
            ...
            def __call__(self, type, item_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("newsfeed.unsubscribe", type = type, owner_id = owner_id, item_id = item_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class notes:
        ...
        class add:
            ...
            def __call__(self, title, text, privacy_view : str = None, privacy_comment : str = None, privacy : int = None, comment_privacy : int = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.add", title = title, text = text, privacy_view = privacy_view, privacy_comment = privacy_comment, privacy = privacy, comment_privacy = comment_privacy, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class createComment:
            ...
            def __call__(self, note_id, message, owner_id : int = None, reply_to : int = None, guid : str = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.createComment", note_id = note_id, owner_id = owner_id, reply_to = reply_to, message = message, guid = guid, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, note_id, v : str = None, access_token : str = None):
                return self.exec_func("notes.delete", note_id = note_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.deleteComment", comment_id = comment_id, owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, note_id, title, text, privacy_view : str = None, privacy_comment : str = None, privacy : int = None, comment_privacy : int = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.edit", note_id = note_id, title = title, text = text, privacy_view = privacy_view, privacy_comment = privacy_comment, privacy = privacy, comment_privacy = comment_privacy, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, message : str = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.editComment", comment_id = comment_id, owner_id = owner_id, message = message, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, note_ids : str = None, user_id : int = None, offset : int = None, count : int = None, sort : int = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.get", note_ids = note_ids, user_id = user_id, offset = offset, count = count, sort = sort, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, note_id, owner_id : int = None, need_wiki : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.getById", note_id = note_id, owner_id = owner_id, need_wiki = need_wiki, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getComments:
            ...
            def __call__(self, note_id, owner_id : int = None, sort : int = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.getComments", note_id = note_id, owner_id = owner_id, sort = sort, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restoreComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("notes.restoreComment", comment_id = comment_id, owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class notifications:
        ...
        class get:
            ...
            def __call__(self, count : int = None, start_from : str = None, filters : str = None, start_time : int = None, end_time : int = None, from_ : str = None, offset : int = None, v : str = None, access_token : str = None):
                return self.exec_func("notifications.get", count = count, start_from = start_from, filters = filters, start_time = start_time, end_time = end_time, from_ = from_, offset = offset, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class markAsViewed:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("notifications.markAsViewed", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class sendMessage:
            ...
            def __call__(self, user_ids, message, fragment : str = None, group_id : int = None, random_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("notifications.sendMessage", user_ids = user_ids, message = message, fragment = fragment, group_id = group_id, random_id = random_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class pages:
        ...
        class clearCache:
            ...
            def __call__(self, url, v : str = None, access_token : str = None):
                return self.exec_func("pages.clearCache", url = url, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, owner_id : int = None, page_id : int = None, global_ : bool = None, site_preview : bool = None, title : str = None, need_source : bool = None, need_html : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("pages.get", owner_id = owner_id, page_id = page_id, global_ = global_, site_preview = site_preview, title = title, need_source = need_source, need_html = need_html, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getHistory:
            ...
            def __call__(self, page_id, group_id : int = None, user_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("pages.getHistory", page_id = page_id, group_id = group_id, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getTitles:
            ...
            def __call__(self, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("pages.getTitles", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getVersion:
            ...
            def __call__(self, version_id, group_id : int = None, user_id : int = None, need_html : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("pages.getVersion", version_id = version_id, group_id = group_id, user_id = user_id, need_html = need_html, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class parseWiki:
            ...
            def __call__(self, text, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("pages.parseWiki", text = text, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class save:
            ...
            def __call__(self, text : str = None, page_id : int = None, group_id : int = None, user_id : int = None, title : str = None, v : str = None, access_token : str = None):
                return self.exec_func("pages.save", text = text, page_id = page_id, group_id = group_id, user_id = user_id, title = title, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveAccess:
            ...
            def __call__(self, page_id, group_id : int = None, user_id : int = None, view : int = None, edit : int = None, v : str = None, access_token : str = None):
                return self.exec_func("pages.saveAccess", page_id = page_id, group_id = group_id, user_id = user_id, view = view, edit = edit, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class photos:
        ...
        class confirmTag:
            ...
            def __call__(self, photo_id, tag_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.confirmTag", owner_id = owner_id, photo_id = photo_id, tag_id = tag_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class copy:
            ...
            def __call__(self, owner_id, photo_id, access_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.copy", owner_id = owner_id, photo_id = photo_id, access_key = access_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class createComment:
            ...
            def __call__(self, photo_id, owner_id : int = None, message : str = None, attachments : str = None, from_group : bool = None, reply_to_comment : int = None, sticker_id : int = None, access_key : str = None, guid : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.createComment", owner_id = owner_id, photo_id = photo_id, message = message, attachments = attachments, from_group = from_group, reply_to_comment = reply_to_comment, sticker_id = sticker_id, access_key = access_key, guid = guid, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, photo_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.delete", owner_id = owner_id, photo_id = photo_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteAlbum:
            ...
            def __call__(self, album_id, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.deleteAlbum", album_id = album_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.deleteComment", owner_id = owner_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, photo_id, owner_id : int = None, caption : str = None, latitude : int = None, longitude : int = None, place_str : str = None, foursquare_id : str = None, delete_place : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.edit", owner_id = owner_id, photo_id = photo_id, caption = caption, latitude = latitude, longitude = longitude, place_str = place_str, foursquare_id = foursquare_id, delete_place = delete_place, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, message : str = None, attachments : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.editComment", owner_id = owner_id, comment_id = comment_id, message = message, attachments = attachments, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, owner_id : int = None, album_id : str = None, photo_ids : str = None, rev : bool = None, extended : bool = None, feed_type : str = None, feed : int = None, photo_sizes : bool = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.get", owner_id = owner_id, album_id = album_id, photo_ids = photo_ids, rev = rev, extended = extended, feed_type = feed_type, feed = feed, photo_sizes = photo_sizes, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAlbums:
            ...
            def __call__(self, owner_id : int = None, album_ids : str = None, offset : int = None, count : int = None, need_system : bool = None, need_covers : bool = None, photo_sizes : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getAlbums", owner_id = owner_id, album_ids = album_ids, offset = offset, count = count, need_system = need_system, need_covers = need_covers, photo_sizes = photo_sizes, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAlbumsCount:
            ...
            def __call__(self, user_id : int = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getAlbumsCount", user_id = user_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAll:
            ...
            def __call__(self, owner_id : int = None, extended : bool = None, offset : int = None, count : int = None, photo_sizes : bool = None, no_service_albums : bool = None, need_hidden : bool = None, skip_hidden : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getAll", owner_id = owner_id, extended = extended, offset = offset, count = count, photo_sizes = photo_sizes, no_service_albums = no_service_albums, need_hidden = need_hidden, skip_hidden = skip_hidden, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAllComments:
            ...
            def __call__(self, owner_id : int = None, album_id : int = None, need_likes : bool = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getAllComments", owner_id = owner_id, album_id = album_id, need_likes = need_likes, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, photos, extended : bool = None, photo_sizes : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getById", photos = photos, extended = extended, photo_sizes = photo_sizes, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getChatUploadServer:
            ...
            def __call__(self, chat_id, crop_x : int = None, crop_y : int = None, crop_width : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getChatUploadServer", chat_id = chat_id, crop_x = crop_x, crop_y = crop_y, crop_width = crop_width, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMarketAlbumUploadServer:
            ...
            def __call__(self, group_id, v : str = None, access_token : str = None):
                return self.exec_func("photos.getMarketAlbumUploadServer", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMarketUploadServer:
            ...
            def __call__(self, group_id, main_photo : bool = None, crop_x : int = None, crop_y : int = None, crop_width : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getMarketUploadServer", group_id = group_id, main_photo = main_photo, crop_x = crop_x, crop_y = crop_y, crop_width = crop_width, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getMessagesUploadServer:
            ...
            def __call__(self, peer_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getMessagesUploadServer", peer_id = peer_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getNewTags:
            ...
            def __call__(self, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getNewTags", offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getOwnerCoverPhotoUploadServer:
            ...
            def __call__(self, group_id, crop_x : int = None, crop_y : int = None, crop_x2 : int = None, crop_y2 : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getOwnerCoverPhotoUploadServer", group_id = group_id, crop_x = crop_x, crop_y = crop_y, crop_x2 = crop_x2, crop_y2 = crop_y2, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getOwnerPhotoUploadServer:
            ...
            def __call__(self, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getOwnerPhotoUploadServer", owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getTags:
            ...
            def __call__(self, photo_id, owner_id : int = None, access_key : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getTags", owner_id = owner_id, photo_id = photo_id, access_key = access_key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getUploadServer:
            ...
            def __call__(self, album_id : int = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getUploadServer", album_id = album_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getUserPhotos:
            ...
            def __call__(self, user_id : int = None, offset : int = None, count : int = None, extended : bool = None, sort : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getUserPhotos", user_id = user_id, offset = offset, count = count, extended = extended, sort = sort, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getWallUploadServer:
            ...
            def __call__(self, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.getWallUploadServer", group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class makeCover:
            ...
            def __call__(self, photo_id, owner_id : int = None, album_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.makeCover", owner_id = owner_id, photo_id = photo_id, album_id = album_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class move:
            ...
            def __call__(self, target_album_id, photo_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.move", owner_id = owner_id, target_album_id = target_album_id, photo_id = photo_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class putTag:
            ...
            def __call__(self, photo_id, user_id, owner_id : int = None, x : int = None, y : int = None, x2 : int = None, y2 : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.putTag", owner_id = owner_id, photo_id = photo_id, user_id = user_id, x = x, y = y, x2 = x2, y2 = y2, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeTag:
            ...
            def __call__(self, photo_id, tag_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.removeTag", owner_id = owner_id, photo_id = photo_id, tag_id = tag_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reorderAlbums:
            ...
            def __call__(self, album_id, owner_id : int = None, before : int = None, after : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.reorderAlbums", owner_id = owner_id, album_id = album_id, before = before, after = after, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reorderPhotos:
            ...
            def __call__(self, photo_id, owner_id : int = None, before : int = None, after : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.reorderPhotos", owner_id = owner_id, photo_id = photo_id, before = before, after = after, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class report:
            ...
            def __call__(self, owner_id, photo_id, reason : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.report", owner_id = owner_id, photo_id = photo_id, reason = reason, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reportComment:
            ...
            def __call__(self, owner_id, comment_id, reason : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.reportComment", owner_id = owner_id, comment_id = comment_id, reason = reason, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restore:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"owner_id": {"desc": "идентификатор пользователя или сообщества, которому принадлежит фотография. Обратите внимание, идентификатор сообщества в параметре owner_id необходимо указывать со знаком \"-\" — например, owner_id=-1 соответствует идентификатору сообщества ВКонтакте API (club1)  целое число, по умолчанию идентификатор текущего пользователя", "type": "int", "default": "идентификатор текущего пользователя"}, "photo_id": {"desc": "идентификатор фотографии. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, photo_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.restore", owner_id = owner_id, photo_id = photo_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restoreComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.restoreComment", owner_id = owner_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class save:
            ...
            def __call__(self, album_id : int = None, group_id : int = None, server : int = None, photos_list : str = None, hash : str = None, latitude : int = None, longitude : int = None, caption : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.save", album_id = album_id, group_id = group_id, server = server, photos_list = photos_list, hash = hash, latitude = latitude, longitude = longitude, caption = caption, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveMarketAlbumPhoto:
            ...
            def __call__(self, group_id, photo, server, hash, v : str = None, access_token : str = None):
                return self.exec_func("photos.saveMarketAlbumPhoto", group_id = group_id, photo = photo, server = server, hash = hash, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveMarketPhoto:
            ...
            def __call__(self, photo, server, hash, group_id : int = None, crop_data : str = None, crop_hash : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.saveMarketPhoto", group_id = group_id, photo = photo, server = server, hash = hash, crop_data = crop_data, crop_hash = crop_hash, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveMessagesPhoto:
            ...
            def __call__(self, photo, server : int = None, hash : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.saveMessagesPhoto", photo = photo, server = server, hash = hash, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveOwnerCoverPhoto:
            ...
            def __call__(self, hash, photo, v : str = None, access_token : str = None):
                return self.exec_func("photos.saveOwnerCoverPhoto", hash = hash, photo = photo, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveOwnerPhoto:
            ...
            def __call__(self, server : str = None, hash : str = None, photo : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.saveOwnerPhoto", server = server, hash = hash, photo = photo, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class saveWallPhoto:
            ...
            def __call__(self, photo, user_id : int = None, group_id : int = None, server : int = None, hash : str = None, latitude : int = None, longitude : int = None, caption : str = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.saveWallPhoto", user_id = user_id, group_id = group_id, photo = photo, server = server, hash = hash, latitude = latitude, longitude = longitude, caption = caption, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, q : str = None, lat : int = None, long : int = None, start_time : int = None, end_time : int = None, sort : int = None, offset : int = None, count : int = None, radius : int = None, v : str = None, access_token : str = None):
                return self.exec_func("photos.search", q = q, lat = lat, long = long, start_time = start_time, end_time = end_time, sort = sort, offset = offset, count = count, radius = radius, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class polls:
        ...
        class addVote:
            ...
            def __call__(self, poll_id, answer_ids, owner_id : int = None, is_board : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("polls.addVote", owner_id = owner_id, poll_id = poll_id, answer_ids = answer_ids, is_board = is_board, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class create:
            ...
            def __call__(self, question : str = None, is_anonymous : bool = None, is_multiple : bool = None, end_date : int = None, owner_id : int = None, add_answers = None, photo_id : int = None, background_id = None, disable_unvote : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("polls.create", question = question, is_anonymous = is_anonymous, is_multiple = is_multiple, end_date = end_date, owner_id = owner_id, add_answers = add_answers, photo_id = photo_id, background_id = background_id, disable_unvote = disable_unvote, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteVote:
            ...
            def __call__(self, poll_id, answer_id, owner_id : int = None, is_board : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("polls.deleteVote", owner_id = owner_id, poll_id = poll_id, answer_id = answer_id, is_board = is_board, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, poll_id, owner_id : int = None, question : str = None, add_answers = None, edit_answers = None, delete_answers = None, end_date : int = None, photo_id : int = None, background_id = None, v : str = None, access_token : str = None):
                return self.exec_func("polls.edit", owner_id = owner_id, poll_id = poll_id, question = question, add_answers = add_answers, edit_answers = edit_answers, delete_answers = delete_answers, end_date = end_date, photo_id = photo_id, background_id = background_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getBackgrounds:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("polls.getBackgrounds", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, poll_id, owner_id : int = None, is_board : bool = None, extended : bool = None, friends_count : int = None, fields : str = None, name_case = None, v : str = None, access_token : str = None):
                return self.exec_func("polls.getById", owner_id = owner_id, is_board = is_board, poll_id = poll_id, extended = extended, friends_count = friends_count, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getPhotoUploadServer:
            ...
            def __call__(self, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("polls.getPhotoUploadServer", owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getVoters:
            ...
            def __call__(self, poll_id, answer_ids, owner_id : int = None, is_board : bool = None, friends_only : bool = None, offset : int = None, count : int = None, fields : str = None, name_case : str = None, v : str = None, access_token : str = None):
                return self.exec_func("polls.getVoters", owner_id = owner_id, poll_id = poll_id, answer_ids = answer_ids, is_board = is_board, friends_only = friends_only, offset = offset, count = count, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class savePhoto:
            ...
            def __call__(self, photo, hash, v : str = None, access_token : str = None):
                return self.exec_func("polls.savePhoto", photo = photo, hash = hash, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class prettyCards:
        ...
        class create:
            ...
            def __call__(self, owner_id, photo, title, link, price : str = None, price_old : str = None, button : str = None, v : str = None, access_token : str = None):
                return self.exec_func("prettyCards.create", owner_id = owner_id, photo = photo, title = title, link = link, price = price, price_old = price_old, button = button, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, owner_id, card_id, v : str = None, access_token : str = None):
                return self.exec_func("prettyCards.delete", owner_id = owner_id, card_id = card_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, owner_id, card_id, photo : str = None, title : str = None, link : str = None, price : str = None, price_old : str = None, button : str = None, v : str = None, access_token : str = None):
                return self.exec_func("prettyCards.edit", owner_id = owner_id, card_id = card_id, photo = photo, title = title, link = link, price = price, price_old = price_old, button = button, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, owner_id, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("prettyCards.get", owner_id = owner_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, owner_id, card_ids, v : str = None, access_token : str = None):
                return self.exec_func("prettyCards.getById", owner_id = owner_id, card_ids = card_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getUploadURL:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("prettyCards.getUploadURL", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class search:
        ...
        class getHints:
            ...
            def __call__(self, q : str = None, offset : int = None, limit : int = None, filters : str = None, fields : str = None, search_global : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("search.getHints", q = q, offset = offset, limit = limit, filters = filters, fields = fields, search_global = search_global, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class stats:
        ...
        class get:
            ...
            def __call__(self, group_id : int = None, app_id : int = None, timestamp_from : int = None, timestamp_to : int = None, interval : str = None, intervals_count : int = None, filters : str = None, stats_groups : str = None, extended : bool = None, date_from : str = None, date_to : str = None, v : str = None, access_token : str = None):
                return self.exec_func("stats.get", group_id = group_id, app_id = app_id, timestamp_from = timestamp_from, timestamp_to = timestamp_to, interval = interval, intervals_count = intervals_count, filters = filters, stats_groups = stats_groups, extended = extended, date_from = date_from, date_to = date_to, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getPostReach:
            ...
            def __call__(self, owner_id, post_ids, v : str = None, access_token : str = None):
                return self.exec_func("stats.getPostReach", owner_id = owner_id, post_ids = post_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class trackVisitor:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("stats.trackVisitor", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class status:
        ...
        class get:
            ...
            def __call__(self, user_id : int = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("status.get", user_id = user_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class set:
            ...
            def __call__(self, text : str = None, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("status.set", text = text, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class storage:
        ...
        class get:
            ...
            def __call__(self, key : str = None, keys : str = None, user_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("storage.get", key = key, keys = keys, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getKeys:
            ...
            def __call__(self, user_id : int = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("storage.getKeys", user_id = user_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class set:
            ...
            def __call__(self, key, value : str = None, user_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("storage.set", key = key, value = value, user_id = user_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class stories:
        ...
        class banOwner:
            ...
            def __call__(self, owners_ids, v : str = None, access_token : str = None):
                return self.exec_func("stories.banOwner", owners_ids = owners_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, owner_id : int = None, story_id : int = None, stories : str = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.delete", owner_id = owner_id, story_id = story_id, stories = stories, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, owner_id : int = None, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.get", owner_id = owner_id, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getBanned:
            ...
            def __call__(self, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.getBanned", extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, stories, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.getById", stories = stories, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getPhotoUploadServer:
            ...
            def __call__(self, add_to_news : bool = None, user_ids : str = None, reply_to_story : str = None, link_text : str = None, link_url : str = None, group_id : int = None, clickable_stickers = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.getPhotoUploadServer", add_to_news = add_to_news, user_ids = user_ids, reply_to_story = reply_to_story, link_text = link_text, link_url = link_url, group_id = group_id, clickable_stickers = clickable_stickers, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getReplies:
            ...
            def __call__(self, owner_id, story_id, access_key : str = None, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.getReplies", owner_id = owner_id, story_id = story_id, access_key = access_key, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getStats:
            ...
            def __call__(self, owner_id, story_id, v : str = None, access_token : str = None):
                return self.exec_func("stories.getStats", owner_id = owner_id, story_id = story_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getVideoUploadServer:
            ...
            def __call__(self, add_to_news : bool = None, user_ids : str = None, reply_to_story : str = None, link_text : str = None, link_url : str = None, group_id : int = None, clickable_stickers = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.getVideoUploadServer", add_to_news = add_to_news, user_ids = user_ids, reply_to_story = reply_to_story, link_text = link_text, link_url = link_url, group_id = group_id, clickable_stickers = clickable_stickers, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getViewers:
            ...
            def __call__(self, owner_id, story_id, count : int = None, offset : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.getViewers", owner_id = owner_id, story_id = story_id, count = count, offset = offset, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class hideAllReplies:
            ...
            def __call__(self, owner_id, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.hideAllReplies", owner_id = owner_id, group_id = group_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class hideReply:
            ...
            def __call__(self, owner_id, story_id, v : str = None, access_token : str = None):
                return self.exec_func("stories.hideReply", owner_id = owner_id, story_id = story_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class save:
            ...
            def __call__(self, upload_results, v : str = None, access_token : str = None):
                return self.exec_func("stories.save", upload_results = upload_results, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, q : str = None, place_id : int = None, latitude : int = None, longitude : int = None, radius : int = None, mentioned_id : int = None, count : int = None, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.search", q = q, place_id = place_id, latitude = latitude, longitude = longitude, radius = radius, mentioned_id = mentioned_id, count = count, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class sendInteraction:
            ...
            def __call__(self, access_key, message : str = None, is_broadcast : bool = None, is_anonymous : bool = None, unseen_marker : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("stories.sendInteraction", access_key = access_key, message = message, is_broadcast = is_broadcast, is_anonymous = is_anonymous, unseen_marker = unseen_marker, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unbanOwner:
            ...
            def __call__(self, owners_ids, v : str = None, access_token : str = None):
                return self.exec_func("stories.unbanOwner", owners_ids = owners_ids, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class streaming:
        ...
        class getServerUrl:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("streaming.getServerUrl", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSettings:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("streaming.getSettings", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getStats:
            ...
            def __call__(self, type : str = None, interval : str = None, start_time : int = None, end_time : int = None, v : str = None, access_token : str = None):
                return self.exec_func("streaming.getStats", type = type, interval = interval, start_time = start_time, end_time = end_time, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getStem:
            ...
            def __call__(self, word, v : str = None, access_token : str = None):
                return self.exec_func("streaming.getStem", word = word, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class setSettings:
            ...
            def __call__(self, monthly_tier : str = None, v : str = None, access_token : str = None):
                return self.exec_func("streaming.setSettings", monthly_tier = monthly_tier, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class users:
        ...
        class get:
            ...
            def __call__(self, user_ids : str = None, fields : str = None, name_case : str = None, v : str = None, access_token : str = None):
                return self.exec_func("users.get", user_ids = user_ids, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getFollowers:
            ...
            def __call__(self, user_id : int = None, offset : int = None, count : int = None, fields : str = None, name_case : str = None, v : str = None, access_token : str = None):
                return self.exec_func("users.getFollowers", user_id = user_id, offset = offset, count = count, fields = fields, name_case = name_case, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getSubscriptions:
            ...
            def __call__(self, user_id : int = None, extended : bool = None, offset : int = None, count : int = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("users.getSubscriptions", user_id = user_id, extended = extended, offset = offset, count = count, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class report:
            ...
            def __call__(self, user_id, type, comment : str = None, v : str = None, access_token : str = None):
                return self.exec_func("users.report", user_id = user_id, type = type, comment = comment, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class utils:
        ...
        class checkLink:
            ...
            def __call__(self, url, v : str = None, access_token : str = None):
                return self.exec_func("utils.checkLink", url = url, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteFromLastShortened:
            ...
            def __call__(self, key, v : str = None, access_token : str = None):
                return self.exec_func("utils.deleteFromLastShortened", key = key, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLastShortenedLinks:
            ...
            def __call__(self, count : int = None, offset : int = None, v : str = None, access_token : str = None):
                return self.exec_func("utils.getLastShortenedLinks", count = count, offset = offset, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getLinkStats:
            ...
            def __call__(self, key, source : str = None, access_key : str = None, interval : str = None, intervals_count : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("utils.getLinkStats", key = key, source = source, access_key = access_key, interval = interval, intervals_count = intervals_count, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getServerTime:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {}
            def __call__(self, v : str = None, access_token : str = None):
                return self.exec_func("utils.getServerTime", v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getShortLink:
            ...
            def __call__(self, url, private : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("utils.getShortLink", url = url, private = private, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class resolveScreenName:
            ...
            def __call__(self, screen_name, v : str = None, access_token : str = None):
                return self.exec_func("utils.resolveScreenName", screen_name = screen_name, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class video:
        ...
        class add:
            ...
            def __call__(self, video_id, owner_id, target_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.add", target_id = target_id, video_id = video_id, owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addAlbum:
            ...
            def __call__(self, group_id : int = None, title : str = None, privacy : str = None, v : str = None, access_token : str = None):
                return self.exec_func("video.addAlbum", group_id = group_id, title = title, privacy = privacy, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class addToAlbum:
            ...
            def __call__(self, owner_id, video_id, target_id : int = None, album_id : int = None, album_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("video.addToAlbum", target_id = target_id, album_id = album_id, album_ids = album_ids, owner_id = owner_id, video_id = video_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class createComment:
            ...
            def __call__(self, video_id, owner_id : int = None, message : str = None, attachments : str = None, from_group : bool = None, reply_to_comment : int = None, sticker_id : int = None, guid : str = None, v : str = None, access_token : str = None):
                return self.exec_func("video.createComment", owner_id = owner_id, video_id = video_id, message = message, attachments = attachments, from_group = from_group, reply_to_comment = reply_to_comment, sticker_id = sticker_id, guid = guid, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, video_id, owner_id : int = None, target_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.delete", video_id = video_id, owner_id = owner_id, target_id = target_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteAlbum:
            ...
            def __call__(self, album_id, group_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.deleteAlbum", group_id = group_id, album_id = album_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.deleteComment", owner_id = owner_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class edit:
            ...
            def __call__(self, video_id, owner_id : int = None, name : str = None, desc : str = None, privacy_view : str = None, privacy_comment : str = None, no_comments : bool = None, repeat : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("video.edit", owner_id = owner_id, video_id = video_id, name = name, desc = desc, privacy_view = privacy_view, privacy_comment = privacy_comment, no_comments = no_comments, repeat = repeat, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editAlbum:
            ...
            def __call__(self, album_id, title, group_id : int = None, privacy : str = None, v : str = None, access_token : str = None):
                return self.exec_func("video.editAlbum", group_id = group_id, album_id = album_id, title = title, privacy = privacy, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, message : str = None, attachments : str = None, v : str = None, access_token : str = None):
                return self.exec_func("video.editComment", owner_id = owner_id, comment_id = comment_id, message = message, attachments = attachments, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, owner_id : int = None, videos : str = None, album_id : int = None, count : int = None, offset : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("video.get", owner_id = owner_id, videos = videos, album_id = album_id, count = count, offset = offset, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAlbumById:
            ...
            def __call__(self, album_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.getAlbumById", owner_id = owner_id, album_id = album_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAlbums:
            ...
            def __call__(self, owner_id : int = None, offset : int = None, count : int = None, extended : bool = None, need_system : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("video.getAlbums", owner_id = owner_id, offset = offset, count = count, extended = extended, need_system = need_system, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getAlbumsByVideo:
            ...
            def __call__(self, owner_id, video_id, target_id : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("video.getAlbumsByVideo", target_id = target_id, owner_id = owner_id, video_id = video_id, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getComments:
            ...
            def __call__(self, video_id, owner_id : int = None, need_likes : bool = None, start_comment_id : int = None, offset : int = None, count : int = None, sort : str = None, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("video.getComments", owner_id = owner_id, video_id = video_id, need_likes = need_likes, start_comment_id = start_comment_id, offset = offset, count = count, sort = sort, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class removeFromAlbum:
            ...
            def __call__(self, owner_id, video_id, target_id : int = None, album_id : int = None, album_ids : str = None, v : str = None, access_token : str = None):
                return self.exec_func("video.removeFromAlbum", target_id = target_id, album_id = album_id, album_ids = album_ids, owner_id = owner_id, video_id = video_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reorderAlbums:
            ...
            def __call__(self, album_id, owner_id : int = None, before : int = None, after : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.reorderAlbums", owner_id = owner_id, album_id = album_id, before = before, after = after, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reorderVideos:
            ...
            def __call__(self, owner_id, video_id, target_id : int = None, album_id : int = None, before_owner_id : int = None, before_video_id : int = None, after_owner_id : int = None, after_video_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.reorderVideos", target_id = target_id, album_id = album_id, owner_id = owner_id, video_id = video_id, before_owner_id = before_owner_id, before_video_id = before_video_id, after_owner_id = after_owner_id, after_video_id = after_video_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class report:
            ...
            def __call__(self, owner_id, video_id, reason : int = None, comment : str = None, search_query : str = None, v : str = None, access_token : str = None):
                return self.exec_func("video.report", owner_id = owner_id, video_id = video_id, reason = reason, comment = comment, search_query = search_query, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reportComment:
            ...
            def __call__(self, owner_id, comment_id, reason : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.reportComment", owner_id = owner_id, comment_id = comment_id, reason = reason, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restore:
            ...
            def __call__(self, video_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.restore", video_id = video_id, owner_id = owner_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restoreComment:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"owner_id": {"desc": "идентификатор пользователя или сообщества, которому принадлежит видеозапись. Обратите внимание, идентификатор сообщества в параметре owner_id необходимо указывать со знаком \"-\" — например, owner_id=-1 соответствует идентификатору сообщества ВКонтакте API (club1)  целое число, по умолчанию идентификатор текущего пользователя", "type": "int", "default": "идентификатор текущего пользователя"}, "comment_id": {"desc": "идентификатор удаленного комментария. целое число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, comment_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("video.restoreComment", owner_id = owner_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class save:
            ...
            def __call__(self, name : str = None, description : str = None, is_private : bool = None, wallpost : bool = None, link : str = None, group_id : int = None, album_id : int = None, privacy_view : str = None, privacy_comment : str = None, no_comments : bool = None, repeat : bool = None, compression : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("video.save", name = name, description = description, is_private = is_private, wallpost = wallpost, link = link, group_id = group_id, album_id = album_id, privacy_view = privacy_view, privacy_comment = privacy_comment, no_comments = no_comments, repeat = repeat, compression = compression, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, q, sort : int = None, hd : int = None, adult : bool = None, filters : str = None, search_own : bool = None, offset : int = None, longer : int = None, shorter : int = None, count : int = None, extended : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("video.search", q = q, sort = sort, hd = hd, adult = adult, filters = filters, search_own = search_own, offset = offset, longer = longer, shorter = shorter, count = count, extended = extended, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class wall:
        ...
        class checkCopyrightLink:
            ...
            def __call__(self, link, v : str = None, access_token : str = None):
                return self.exec_func("wall.checkCopyrightLink", link = link, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class closeComments:
            ...
            def __call__(self, owner_id, post_id, v : str = None, access_token : str = None):
                return self.exec_func("wall.closeComments", owner_id = owner_id, post_id = post_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class createComment:
            ...
            def __call__(self, post_id, owner_id : int = None, from_group : int = None, message : str = None, reply_to_comment : int = None, attachments : str = None, sticker_id : int = None, guid : str = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.createComment", owner_id = owner_id, post_id = post_id, from_group = from_group, message = message, reply_to_comment = reply_to_comment, attachments = attachments, sticker_id = sticker_id, guid = guid, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class delete:
            ...
            def __call__(self, owner_id : int = None, post_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.delete", owner_id = owner_id, post_id = post_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class deleteComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.deleteComment", owner_id = owner_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editAdsStealth:
            ...
            def __call__(self, post_id, owner_id : int = None, message : str = None, attachments : str = None, signed : bool = None, lat : int = None, long : int = None, place_id : int = None, link_button : str = None, link_title : str = None, link_image : str = None, link_video : str = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.editAdsStealth", owner_id = owner_id, post_id = post_id, message = message, attachments = attachments, signed = signed, lat = lat, long = long, place_id = place_id, link_button = link_button, link_title = link_title, link_image = link_image, link_video = link_video, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class editComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, message : str = None, attachments : str = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.editComment", owner_id = owner_id, comment_id = comment_id, message = message, attachments = attachments, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class get:
            ...
            def __call__(self, owner_id : int = None, domain : str = None, offset : int = None, count : int = None, filter : str = None, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.get", owner_id = owner_id, domain = domain, offset = offset, count = count, filter = filter, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getById:
            ...
            def __call__(self, posts, extended : bool = None, copy_history_depth : int = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.getById", posts = posts, extended = extended, copy_history_depth = copy_history_depth, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.getComment", owner_id = owner_id, comment_id = comment_id, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getReposts:
            ...
            def __call__(self, owner_id : int = None, post_id : int = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.getReposts", owner_id = owner_id, post_id = post_id, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class openComments:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"owner_id": {"desc": "целое число, обязательный параметр", "type": "int", "default": "None"}, "post_id": {"desc": "положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, owner_id, post_id, v : str = None, access_token : str = None):
                return self.exec_func("wall.openComments", owner_id = owner_id, post_id = post_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class pin:
            ...
            def __call__(self, post_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.pin", owner_id = owner_id, post_id = post_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class postAdsStealth:
            ...
            def __call__(self, owner_id, message : str = None, attachments : str = None, signed : bool = None, lat : int = None, long : int = None, place_id : int = None, guid : str = None, link_button : str = None, link_title : str = None, link_image : str = None, link_video : str = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.postAdsStealth", owner_id = owner_id, message = message, attachments = attachments, signed = signed, lat = lat, long = long, place_id = place_id, guid = guid, link_button = link_button, link_title = link_title, link_image = link_image, link_video = link_video, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reportComment:
            ...
            def __call__(self, owner_id, comment_id, reason : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.reportComment", owner_id = owner_id, comment_id = comment_id, reason = reason, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class reportPost:
            ...
            def __call__(self, owner_id, post_id, reason : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.reportPost", owner_id = owner_id, post_id = post_id, reason = reason, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class repost:
            ...
            def __call__(self, object, message : str = None, group_id : int = None, mark_as_ads : bool = None, mute_notifications : bool = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.repost", object = object, message = message, group_id = group_id, mark_as_ads = mark_as_ads, mute_notifications = mute_notifications, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restore:
            ...
            def __call__(self, owner_id : int = None, post_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.restore", owner_id = owner_id, post_id = post_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class restoreComment:
            ...
            def __call__(self, comment_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.restoreComment", owner_id = owner_id, comment_id = comment_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class search:
            ...
            def __call__(self, owner_id : int = None, domain : str = None, query : str = None, owners_only : bool = None, count : int = None, offset : int = None, extended : bool = None, fields : str = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.search", owner_id = owner_id, domain = domain, query = query, owners_only = owners_only, count = count, offset = offset, extended = extended, fields = fields, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class unpin:
            ...
            def __init__(self, exec_func):
                ...
                self.args = {"owner_id": {"desc": "идентификатор пользователя или сообщества, на стене которого находится запись. Обратите внимание, идентификатор сообщества в параметре owner_id необходимо указывать со знаком \"-\" — например, owner_id=-1 соответствует идентификатору сообщества ВКонтакте API (club1)  целое число, по умолчанию идентификатор текущего пользователя", "type": "int", "default": "идентификатор текущего пользователя"}, "post_id": {"desc": "идентификатор записи на стене. положительное число, обязательный параметр", "type": "int", "default": "None"}}
            def __call__(self, post_id, owner_id : int = None, v : str = None, access_token : str = None):
                return self.exec_func("wall.unpin", owner_id = owner_id, post_id = post_id, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
    ...
    class widgets:
        ...
        class getComments:
            ...
            def __call__(self, widget_api_id : int = None, url : str = None, page_id : str = None, order : str = None, fields : str = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("widgets.getComments", widget_api_id = widget_api_id, url = url, page_id = page_id, order = order, fields = fields, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
        ...
        class getPages:
            ...
            def __call__(self, widget_api_id : int = None, order : str = None, period : str = None, offset : int = None, count : int = None, v : str = None, access_token : str = None):
                return self.exec_func("widgets.getPages", widget_api_id = widget_api_id, order = order, period = period, offset = offset, count = count, v = v, access_token = access_token)
            def get_args(self):
                res = []
                for arg in self.args:
                    res.append(arg)
